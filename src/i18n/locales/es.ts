...
export const es: Translation = {
  ...
  valetudo: {
    ...
    config_error: {
      ...
      desc_blocked:
        'El navegador bloqueó la conexión directa al robot (HTTPS→HTTP no permitido). Añade rest_command a configuration.yaml, recarga Home Assistant e inténtalo de nuevo:',
      option_url:
